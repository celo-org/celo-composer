...
// OpenZeppelin Contracts (last updated v4.7.0) (token/ERC20/utils/SafeCall.sol)
...
/**
 * @title SafeCall
 * @dev Wrappers around ERC20, System, and Router operations that throw on failure (when the token
 * contract returns false). Calls that return no value (and instead revert or
 * throw on failure) are also supported, non-reverting calls are assumed to be
 * successful.
 * To use this library you can add a `using SafeCall for * ;` statement to your contract,
